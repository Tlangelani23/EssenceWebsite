...
<head>
    ...
    <style>
        ...
        .form-select:focus{
            ...
            color:#fff;
            border-color:#d6ae73;
            box-shadow:0 0 10px rgba(214,174,115,.4);
        }
...
<div class="container py-5">
    ...
    <form class="card p-4 mb-4">
        ...
        <button
            type="submit"
            class="btn btn-place w-100 mt-3">
            Place Order
        </button>
...
<script>
    ...
    window.onload = function () {
        ...
        for (let product in cartItems) {
            ...
            li.textContent =
                `${product} x${item.qty} - R${lineTotal.toFixed(2)}`;
        ...
        taxValue = baseTotal * 0.15;

        document.getElementById("orderTotal").textContent =
            `R${baseTotal.toFixed(2)}`;

        document.getElementById("tax").textContent =
            `R${taxValue.toFixed(2)}`;
    ...
    function updateDelivery() {
        ...
        const deliveryFee =
            parseFloat(document.getElementById("deliveryMethod").value) || 0;

        updateGrandTotal(deliveryFee);
    }

    function updateGrandTotal(deliveryFee) {

        const grandTotal =
            baseTotal + taxValue + deliveryFee;

        document.getElementById("grandTotal").textContent =
            `R${grandTotal.toFixed(2)}`;
    }

    document.querySelector(".btn-place").addEventListener("click", function (event) {
        ...
        document.querySelector("form").innerHTML = receiptHTML;
    });
